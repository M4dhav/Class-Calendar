...
st.subheader("Step 1: Download your timetable recieved in the email which is in xls file format and convert it to xlsx file format using this [link ↗](https://www.zamzar.com/convert/xls-to-xlsx/)")
